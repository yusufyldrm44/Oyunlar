...
namespace MayinTarlasi
{
    public partial class Form1 : Form
    {
            ...
            else
            {
                ...
                if (s == 0)
                {
                    ...
                    for(int i = 0; i<mayinlarimiz.Count;i++)
                    {
                        ...
                        if (item != null)
                        {
                            if (item.bakildi_==false&&item.mayin_varmi==false)
                            {
        ...
        public int etrafta_kac_mayin_var(Mayin m)
        {
            ...
            if (m.konum_al.X > 0)
            {
                if (mayin_tarlamiz.mayin_al_loc(new Point(m.konum_al.X - 20, m.konum_al.Y)).mayin_varmi)
                {
                    sayi++;
                }
            }
            ...
            {
                if (mayin_tarlamiz.mayin_al_loc(new Point(m.konum_al.X + 20, m.konum_al.Y + 20)).mayin_varmi)
                {
                    sayi++;
                }
            }
            ...
            if (m.konum_al.Y > 0)
            {
                if (mayin_tarlamiz.mayin_al_loc(new Point(m.konum_al.X, m.konum_al.Y - 20)).mayin_varmi)
                {
                    sayi++;
                }
            }
